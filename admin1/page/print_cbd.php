...
<div class="div4">
	<table width = 100% style="border:1px #000000;"  bgcolor="#000000"><tr><td style="height: 100px; width: 200px; border:1px dashed white;" bgcolor="white" align="center">
		<img width=50% height =70%  src="ABHDaySpa.jpg">
		<!-- <div align="center" style="font-size: 17px"><?php echo "AbhaiBhubejhr Day Spa" ?></div> -->
	...
	<div class="div1">
		<div style="font-size: 12px"><?php echo "อภัยภูเบศร เดย์ สปา"; ?></div>
	...
	<div class="div2" >
		...
		<div style="font-size: 20px"><?php echo "คุณ. ".$fname." ".$lname." Tel.(".$phone.")"; ?></div>
